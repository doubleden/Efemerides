...
final class DataStore {
    ...
    let events = [
        ...
        (
            ...
            image: "Создание Соединённого Королевства",
        ...
        (
            ...
            image: "Начало Английской гражданской войны",
        ...
        (
            title: "Дело Дрейфуса",
            image: "Дело Дрейфуса",
            description: "Осуждение Альфреда Дрейфуса, французского армейского офицера, за предательство на основании сфабрикованных доказательств вызвало масштабное общественное возмущение и пересмотр отношения к правосудию и антисемитизму во Франции.5 января 1789 года стал важной вехой в истории Франции и всего мира. В этот день Французский парламент, собравшись в заседании, принял историческое решение: провозгласил себя Национальным собранием. Это решение было ответом на кризис в стране, вызванный финансовыми проблемами, социальным недовольством и несправедливым положением народа.        Провозглашение Национального собрания знаменовало начало Французской революции, которая перевернула устои феодального строя и абсолютизма. Революция привела к крушению старых порядков и установлению принципов равенства, свободы и братства. В ходе революции были приняты ряд исторических документов, включая Декларацию прав человека и гражданина, которая стала символом борьбы за основные права и свободы. Это событие стало точкой перелома не только для Франции, но и для всей Европы, оказавшейся в центре радикальных социальных и политических изменений. Волнения и идеи революции распространились по всему континенту, вдохновляя народы бороться",
            day: "05",
            month: "01",
            year: "1895"
        ),
        (
            ...
            image: "Брак Генриха VIII и Анны Клевской",
        ...
        (
            ...
            image: "Массовые убийства в Базеле",
        ...
        (
            ...
            image: "Окончание Первой мировой войны",
        ...
        (
            ...
            image: "Открытие Парижской мирной конференции",
        ...
        (
            ...
            image: "Созыв первого английского парламента",
        ...
        (
            ...
            image: "Открытие первой школы высшего образования",
        ...
        (
            ...
            image: "Открытие первой американской библиотеки",
        ...
        (
            ...
            image: "Открытие первой австралийской газеты",
        ...
        (
            ...
            image: "Подписание Стамбульской конвенции",
        ...
        (
            ...
            image: "Подписание Договора об основаниях Европейского союза",
        ...
        (
            ...
            image: "Завершение строительства Великой китайской стены",
